# 3D模型创造器! 
[![Build Status](https://travis-ci.com/RXCCCCCC/dlut-aigc-project.svg?branch=master)](https://travis-ci.com/RXCCCCCC/dlut-aigc-project)
## 项目成果展示
...
**Ps:由于我的云服务器暂时未配置 HTTPS,也许语音输入功能暂不可用,若想使用语音输入功能,请进行本地部署.**
